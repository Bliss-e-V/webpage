...
import gilmer from "../../images/posts/images/20250616_gilmer17.png";
import gasteiger from "../../images/posts/images/20250623_gasteiger20.png";
...
const papers = [
    ...
    new Paper("Neural Message Passing for Quantum Chemistry", ["Justin Gilmer", "Samuel S. Schoenholz", "Patrick F. Riley", "Oriol Vinyals", "George E. Dahl"], "https://arxiv.org/pdf/1704.01212", gilmer, new Date("2025-06-16")),
    new Paper("Directional Message Passing for Molecular Graphs", ["Johannes Gasteiger", "Janek Groß", "Stephan Günnemann"], "https://arxiv.org/pdf/2003.03123", gasteiger, new Date("2025-06-23")),
    ...
    new Paper("Training Language Models to Follow Instructions with Human Feedback", ["Ouyang", "et al."], "https://arxiv.org/abs/2203.02155", ouyang, new Date("2025-12-08")),
    new Paper("Constitutional AI: Harmlessness from AI Feedback", ["Bai", "et al."], "https://arxiv.org/abs/2212.08073", bai, new Date("2025-12-15")),
    new Paper("Adversarial Training for High-Stakes Reliability", ["Ziegler", "et al."], "https://arxiv.org/abs/2205.01663", ziegler, new Date("2026-01-12")),
    new Paper("Goal Misgeneralization in Deep Reinforcement Learning", ["Langosco", "et al."], "https://arxiv.org/abs/2105.14111", langosco, new Date("2026-01-19")),
    new Paper("TruthfulQA: Measuring How Models Mimic Human Falsehoods", ["Lin", "et al."], "https://arxiv.org/abs/2109.07958", lin, new Date("2026-01-26")),
    new Paper("Alignment Faking in Large Language Models", ["Greenblatt", "et al."], "https://arxiv.org/abs/2412.14093", greenblatt, new Date("2026-02-02")),
    new Paper("Emergent Misalignment", ["Betley", "et al."], "https://arxiv.org/abs/2502.17424", betley, new Date("2026-02-09")),
];
