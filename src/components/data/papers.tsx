...
const papers = [
    ...
    new Paper("Monet: Mixture of Monosemantic Experts for Transformers", ["Jungwoo Park", "Young Jin Ahn", "Kee-Eung Kim", "Jaewoo Kang"], "https://arxiv.org/abs/2412.04139", monet, new Date(2025, 0, 20)),
]
