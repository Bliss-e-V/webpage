...
const speakersRaw = [
    ...
    new Speaker(
        ...
        "Machine learning for science, with a focus on synthetic biology and bringing computational tools to living systems.",
        "Georgia Channing leads the AI for Science team at Hugging Face.",
        huggingfaceImg,
        "",
        [],
    ),
    ...
    new Speaker(
        ...
        "Vision and representation learning: dense visual features beyond patch-based paradigms.",
        "Thomas Wimmer is a PhD student at ETH Zürich.",
        ethImg,
        "",
        [],
    ),
