...
const speakersRaw = [
    ...
    new Speaker(new Date(2025, 0, 21), "Learning Physical Laws from Data", "Prof. Sven Wang", "HU Berlin", "https://www.meetup.com/bliss-speaker-series/events/303354531/?eventOrigin=bliss_website", false),
    ...
    new Speaker(new Date(2024, 11, 3), "Sequential and Active Decision Making: Bandit Theory", "Prof. Alexandra Carpentier", "University of Potsdam", "https://www.meetup.com/bliss-speaker-series/events/303354565/?eventOrigin=bliss_website", false),
