...
// Logo imports
import googleImg from "../../images/logos/google-white.png";
import microsoftImg from "../../images/logos/microsoft-white.png";
import dfkiImg from "../../images/logos/dfki.jpeg";
import tuImg from "../../images/logos/tu.png";
import fuImg from "../../images/logos/fu-white.png";
import sakanaImg from "../../images/logos/sakana-white.png";
import potsdamImg from "../../images/logos/potsdam-white.png";
import instadeepImg from "../../images/logos/instadeep.png";
import huImg from "../../images/logos/hu.png";
import magdeburgImg from "../../images/logos/magdeburg-white.png";
import merantixImg from "../../images/logos/merantix-white.png";
...
export class Speaker {
    ...
    constructor(
        ...
        public bio: string = "",
        public logo?: ImageMetadata | string,
...
const speakersRaw = [
    ...
    new Speaker(
        ...
        "Thomas Unterthiner",
        "Google DeepMind",
        "https://www.meetup.com/bliss-speaker-series/events/299466047",
    ...
    new Speaker(
        ...
        "https://www.meetup.com/bliss-speaker-series/events/299480129",
    ...
    new Speaker(
        ...
        "Malte Ostendorff",
        "DFKI",
        "https://www.meetup.com/bliss-speaker-series/events/299480149",
    ...
    new Speaker(
        ...
        "Prof. Fatma Deniz",
        "TU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/299480165",
    ...
    new Speaker(
        ...
        "Prof. Wolfgang Hoenig",
        "TU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/299480172",
    ...
    new Speaker(
        new Date("2024-07-09"),
        "Learning molecular models by integrating machine learning and experimental data",
        "Prof. Cecilia Clementi",
        "FU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/299480197",
    ...
    new Speaker(
        ...
        "Veronika Solopova",
        "TU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/303354404",
    ...
    new Speaker(
        ...
        "Robert Lange",
        "Sakana.AI",
        "https://www.meetup.com/bliss-speaker-series/events/303354498",
    ...
    new Speaker(
        ...
        "Prof. Marc Toussaint",
        "TU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/303354520",
    ...
    new Speaker(
        ...
        "https://www.meetup.com/bliss-speaker-series/events/303354531",
    ...
    new Speaker(
        ...
        "Nima Siboni and Miguel Andres",
        "InstaDeep",
        "https://www.meetup.com/bliss-speaker-series/events/303354547",
    ...
    new Speaker(
        ...
        "Prof. Katharina Baum",
        "FU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/303354557",
    ...
    new Speaker(
        ...
        "Prof. Sven Wang",
        "HU Berlin",
        "https://www.meetup.com/bliss-speaker-series/events/303354565/",
    ...
    new Speaker(
        ...
        "https://www.meetup.com/bliss-speaker-series/events/303354572",
    ...
    new Speaker(
        ...
        "https://www.meetup.com/bliss-speaker-series/events/310955905",
    ...
    new Speaker(
        ...
        "Beyza Ermiş",
        "Cohere",
        "https://www.meetup.com/bliss-speaker-series/events/311344080",
    ...
    new Speaker(
        ...
        "Ashley Edwards",
        "Google DeepMind",
        "https://www.meetup.com/bliss-speaker-series/events/311344105",
    ...
    new Speaker(
        ...
        "Ameya Prabhu",
        "Tübingen AI Center",
        "https://www.meetup.com/bliss-speaker-series/events/311344129",
        ...
        "2Bfvmi4ySBs",
        [
            "/images/media/ws2526/20251202_prabhu/prabhu_1.jpeg",
        ]
    ),
    new Speaker(
        new Date("2025-12-16"),
        ...
        "Dilara Gökay",
        "Google DeepMind",
        "https://www.meetup.com/bliss-speaker-series/events/311344158",
    ...
    new Speaker(
        ...
        "Jonas Hübotter",
        "ETH Zurich",
        "https://www.meetup.com/bliss-speaker-series/events/311344179",
        ...
        "7EsrcXXPBRU",
        [
            "/images/media/ws2526/20260113_huebotter/huebotter_1.jpeg",
            "/images/media/ws2526/20260113_huebotter/huebotter_2.jpeg",
        ]
    ),
    new Speaker(
        new Date("2026-01-27"),
        ...
        "https://www.meetup.com/bliss-speaker-series/events/311344201",
        ...
        "",
        [
            "/images/media/ws2526/20260127_watson/watson_1.jpeg",
            "/images/media/ws2526/20260127_watson/watson_2.jpeg",
        ]
    ),
    new Speaker(
        new Date("2026-02-10"),
    ...
    new Speaker(
        ...
        "Another Template Series",
        "Template Speaker 2",
        "Template Affiliation 2",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        microsoftImg
    ...
    new Speaker(
        new Date("2026-04-03T18:00:00"),
        "Yet Another Template Series",
        "Template Speaker 3",
        "Template Affiliation 3",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        new Date("2026-04-17T18:00:00"),
        "Fourth Template Series",
        "Template Speaker 4",
        "Template Affiliation 4",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        ...
        "Fifth Template Series",
        "Template Speaker 5",
        "Template Affiliation 5",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        ...
        "Sixth Template Series",
        "Template Speaker 6",
        "Template Affiliation 6",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        new Date("2026-05-29T18:00:00"),
        "Seventh Template Series",
        "Template Speaker 7",
        "Template Affiliation 7",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        ...
        "Eigth Template Series",
        "Template Speaker 8",
        "Template Affiliation 8",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        new Date("2026-06-26T18:00:00"),
        "Ninth Template Series",
        "Template Speaker 9",
        "Template Affiliation 9",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
    ...
    new Speaker(
        ...
        "Tenth Template Series",
        "Template Speaker 10",
        "Template Affiliation 10",
        "https://www.meetup.com/bliss-speaker-series",
        "A deep dive into the future of Artificial Intelligence and what it holds for humanity.",
        "",
        tuImg
