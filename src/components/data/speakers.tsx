...
const speakersRaw = [
    // === wintersemester 2025===
    new Speaker(new Date("2025-10-21"), "Why do LLMs struggle with long-context?", "Federico Barbero", "DeepMind", "https://www.meetup.com/bliss-speaker-series/events/310955905", false),
    ...
    new Speaker(new Date("2025-12-02"), "TBD", "Ameya Prabhu", "Tübingen", "https://www.meetup.com/bliss-speaker-series/events/", false),
    new Speaker(new Date("2025-12-16"), "TBD", "Dilara Gökay", "DeepMind", "https://www.meetup.com/bliss-speaker-series/events/", false),
    new Speaker(new Date("2026-01-13"), "Test-Time Training Agents for Deep Exploration", "Jonas Hübotter", "ETH", "https://www.meetup.com/bliss-speaker-series/events/", false),
    new Speaker(new Date("2026-01-27"), "Can humans flourish in the age of AI?", "David Watson", "Kings College London", "https://www.meetup.com/bliss-speaker-series/events/", false),
    new Speaker(new Date("2026-02-10"), "The Price of Intelligence: Three risks inherent in LLMs", "Ahmed Salman", "Microsoft", "https://www.meetup.com/bliss-speaker-series/events/", false),
];
