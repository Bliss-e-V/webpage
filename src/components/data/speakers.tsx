...
const speakersRaw = [
    ...
    new Speaker(new Date("2025-05-06"), "to be announced soon", "", "", "", false, true),
    ...
    new Speaker(new Date("2025-06-03"), "to be announced soon", "", "", "", false, true),
    ...
    new Speaker(new Date("2025-07-01"), "to be announced soon", "", "", "", false, true),
