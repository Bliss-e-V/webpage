...
const mediaItems = [
    ...
    new MediaItem(
        ...
        "Prof. Clementi will delve into the exciting intersection of machine learning, experimental science, and molecular modeling. This session offers a comprehensive look at how cutting-edge machine learning techniques can be combined with experimental data to enhance our understanding of molecular dynamics.",
