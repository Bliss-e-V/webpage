...
const workshopsRaw = [
    ...
    new Workshop(new Date("2026-01-07"), "BLISS x dida: Theory Meets Practice #1: Opening the Black Box: A Hands-On Guide to Explainable AI for LLMs", "Reduan Achtibat", "dida and Fraunhofer HHI", "https://luma.com/6n2o37qh", "While Large Language Models have demonstrated unprecedented capabilities in reasoning and retrieval, their internal decision-making processes remain largely opaque. As they grow in complexity, treating these models as 'black boxes' is no longer sufficient for building reliable, safe, and transparent systems.", false, false, didaLogo),
