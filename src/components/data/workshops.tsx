...
const workshopsRaw = [
    ...
    new Workshop(new Date("2026-05-27"), "BLISS x dida: Theory Meets Practice #4: Explainable Scientific Discovery with AI Memory", "Lazar Obradović", "dida and cognee.ai", "https://luma.com/1sre8dy7?utm_source=blisswebsite", "While LLMs make hypothesis generation cheap, current systems still struggle to connect evidence across papers, domains, and mechanisms in a structured and reusable way. We use Cognee to ingest scientific literature, construct graph-based representations of papers and claims, and evaluate candidate hypotheses with explicit graph- and vector-based metrics.", false, false, didaLogo),
    new Workshop(new Date("2026-06-03"), "BLISS x juna.ai: The Heuristic Scientist: Open-Ended Algorithm Discovery with LLMs", "Dr. Nima Siboni", "juna.ai", "https://luma.com/7zfk3orp?utm_source=blisswebsite", "A hands-on workshop on using LLMs as 'heuristic scientists' for open-ended algorithm discovery: generating candidate strategies, turning ideas into executable code, evaluating them with simulations or benchmarks, and refining them through feedback. Participants will build their own small discovery loop and explore the trade-offs between creativity and control, exploration and verification, automation and human judgment.", false, false, junaLogo),
    new Workshop(new Date("2026-06-10"), "BLISS x QuantCo: Build Your Own AI Agent", "Moritz Wilksch, Pavel Zwerschke", "QuantCo", "https://luma.com/brvtw0jd?utm_source=blisswebsite", "A hands-on session transitioning from theory to practice by building a custom AI agent. Start with language model APIs, then create an agent that automates complex document workflows—equipping a model with tools to write, compile, and iteratively fix layout issues in markup code.", false, false, quantcoLogo),
    new Workshop(new Date("2026-06-24"), "BLISS x dida: Theory Meets Practice #5: AI for Precision Medicine: From Foundation Models to Tumor Tissue Profiling in Computational Pathology", "Lukas Ruff, Christina Embacher, Jonas Dippel, Maaike Galama", "dida and Aignostics", "https://luma.com/zzuvu98h?utm_source=blisswebsite", "Digital pathology turns stained tissue slides into gigapixel images — a uniquely demanding frontier for machine learning. Aignostics walks you from core ML research to real-world application: digital pathology fundamentals, building robust pathology foundation models, and hands-on tumor microenvironment profiling with OpenTME and TME Studio.", false, false, didaLogo),
