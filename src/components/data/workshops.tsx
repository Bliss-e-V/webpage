...
const workshopsRaw = [
    ...
    // new Workshop(new Date("2026-04-30"), "BLISS x JetBrains: Workshop on Mastering LLMs for Code Gen", "TBA", "JetBrains", "https://bliss.berlin/workshops?utm_source=blisswebsite", "Workshop for Women and underrepresented genders in Tech: A hands-on workshop on code generation.", false, false, jetbrainsLogo),
