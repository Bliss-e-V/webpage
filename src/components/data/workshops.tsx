...
const workshopsRaw = [
    ...
    new Workshop(new Date("2026-03-20"), "Template Workshop", "Template Host", "Template Organization", "https://example.com/workshop", "A workshop on modern AI techniques.", false, false, googleLogo),
];
